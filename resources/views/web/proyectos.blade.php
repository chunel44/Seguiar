                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="proyectos-imagen">
                            ...
                            <p class="centered text-uppercase proyectos-nombre">cjpf</p>
                    ...
                    <div class="col-md-4">
                        <div class="proyectos-imagen abajo">
                            ...
                            <p class="centered text-uppercase proyectos-nombre">abs</p>
                    ...
                    <div class="col-md-4">
                        <div class="proyectos-imagen">
                            ...
                            <p class="centered text-uppercase proyectos-nombre">inoxidable</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="proyectos-imagen abajo">
                            ...
                            <p class="centered text-uppercase proyectos-nombre">sede</p>
                            <p class="centered-sub text-uppercase proyectos-subnombre">tijuana</p>
                    ...
                    <div class="col-md-4">
                        <div class="proyectos-imagen">
                            ...
                            <p class="centered text-uppercase proyectos-nombre">tpu</p>
                            <p class="centered-sub text-uppercase proyectos-subnombre">ensenada</p>
